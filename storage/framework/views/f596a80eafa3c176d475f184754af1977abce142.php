...
<?php echo $__env->make('templates.complete_profile', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>


<div id='brochure-search-page' class='container-fluid pt-3'>

                <form action='' method="post" id='searchbrochuresform'>
                    <div id='medclient-portfolios-search' class='medclient-search'>
                        <input type='hidden' name='page_author_id' value='<?php echo e(Auth::user()->name); ?>'>
                ...
                <div class='sms-collection'>
                    <form action='' method="post" id='smsbrochuresform'>
                        ...
                        <div class='formfields'>
                            ...
                            <div class='formfield'>
                                <label class='formfield-label mc-animate <?= ($doctor_name != ' ')? 'mcshrink':''; ?>'>Your name (senders/users name):</label>
                                <input type="text" name="doctor_name" value="<?php echo e($doctor_name); ?>" required disabled>
                            </div>
                            <div class='formfield'>
...
.form-group {
  ...
  background: #eee;
                                                        ...
                                                        <label class='formfield-label mc-animate'>Mobile Number: Please include country code eg +27785122210</label>

                         <div class="formfieldss form-group mt-2">
        <input type="text" class="form-control" id="msidn" aria-describedby="emailHelp" placeholder="+27785122210" style="background: #eee; height: 36px;" name="msidn"  pattern="^(?:0|\+?27)(?:\d\s?){9,10}$"/>
    </div>
  ...
  <button class="btn btn-default">Centered button</button>
                     ...
                     <a href="/" class="btn btn-outline-primary mr-2" style="margin-right: 10px;">View Prescripts</a>

                    <a href="/conditions" class="btn btn-outline-primary">View NHS Brochures</a>
                    

                    <a href="/medicines" class="btn btn-outline-primary">View NHS Medicines</a>
                    ...
                    <div class='listing-group-filter' style="display: none">
                      ...
                      <div id="goto-letter-<?php echo $letter; ?>" class="item">
                        ...
                        <div class="list brochure-items">
                          <?php foreach( $posts as $key => $post ) {  
                            ...
                            $display = "none";
                            $type = $post['brochure_show_on_api'];
...
<?php echo $__env->make('templates.categories', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.appnhsmeds', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/users/practitionernew/apps/practitionernew/resources/views/nhsmeds.blade.php ENDPATH**/ ?>