                                ...
                                <table class="table table-striped responsive-table">
                                    ...
                                    <tbody>
                                      ...
                                      <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          <tr>
                                            <td data-th="ID"><span class="bt-content"><?php echo e($user->id); ?></span></td>
                                            <td class="coin-name" data-th="Type"><span class="bt-content">
                                               <sup><span class="text-success" style="font-size: 12px;">New </span></sup> 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/users/practitionernew/apps/practitionernew/resources/views/adminNewUsers.blade.php ENDPATH**/ ?>