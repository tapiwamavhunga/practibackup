...
.columns {
  ...
  <div class="brochures preview" id="top">
    <div class="brochure">
      ...
      <div class="brochure-details">
        <div class="brochure-head">
          <div class="brochure-media">
            ...
            <img src='<?php echo e($result["image"]); ?>'>
            </div>
          </div>
        </div>
        ...
        <div class='brochure-segment' style='background-color:#FFFFFF'>
          ...
          <div class='brochure-segment-image full'>
            <img src='<?php echo e($data); ?>' >
          </div>
          <?php endif; ?>
          <?php if($result["post_content"]): ?>
          <div class="brochure_desc" >
          <?php echo e($result["post_content"]); ?>
      ...
      <?php if($result->acf->segments): ?>
      <?php $__currentLoopData = $result->acf->segments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $segments): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div id='overview' class='brochure-segment' style='background-color:#FFFFFF'>
          <div class='listview_1_of_2 images_1_of_2'>
            <?php if(!empty($segments["title"])): ?>
            ...
            <div class='text list_2_of_1'>
              ...
              <div class='brochure-segment-title'>
                ...
                <h2>
                   ...
                   <?php echo e(strip_tags($segments["title"])); ?> 
                </h2>
              </div>
              <?php endif; ?>
              <div class='brochure-segment-content'>
                  <?php echo e($segments["content"]); ?>
      ...
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php endif; ?>
          ...
          <div class='brochure-buttons' style="margin-top: 50px;">
            ...
            <?php if($downloadable_pdfdocuments): ?>
      <a href='<?php echo e($downloadable_pdfdocuments); ?>' class='brochure-button pdfdownload' target='_blank'>
    ...
    <div id='medical-references' class='brochure-medical-references collapse'>
     ...
     <?php echo e($result->acf->medical_references); ?>
...
.whatsapp-button span {
  ...
  font-weight: 500;
        ...
        <a class="whatsapp-button" onclick="window.open('whatsapp://send?text=Hi I thought you might find this usefull https://www.dischem.co.za/articles/post/<?php echo e($slug); ?>')" >
  ...
  <p>
    ...
    <?php if($result->acf->related_articles): ?>
          <?php $__currentLoopData = $result->acf->related_articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related_article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <a href='https://www.dischem.co.za/articles/post/<?php echo $related_article['slug']; ?> ' class='recent-brochure'>
      ...
      <div class='recent-details'>
        <h3 class='recent-title'><?php echo e($related_article->post_title); ?></h3>
...
<?php /**PATH /srv/users/practitionernew/apps/practitionernew/resources/views/view.blade.php ENDPATH**/ ?>