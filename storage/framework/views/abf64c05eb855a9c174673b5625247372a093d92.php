      ...
      ?>    
          ...
          <div class="auth-form card">
            <div class="card-body">
              ...
              <form name="myform"
                class="signin_validate row g-3" method="POST" action="<?php echo e(route('login')); ?>">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <input type="password" value="" class="form-control" id="password" class="form-control <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-primary  btn-block text-md-middle" style="width: 100%;">
                                    ...
                                    <a class="btn btn-link mt-3" href="<?php echo e(route('password.request')); ?>" style="color: #0179c1; text-align: center; font-size: 13px; width: 100%;">
...
<?php /**PATH /srv/users/practitionernew/apps/practitionernew/resources/views/auth/login.blade.php ENDPATH**/ ?>