                          ...
                          <table class="table table-striped responsive-table">
                            ...
                            @foreach ($posts as $post)
                              ...
                              <tr>
                                ...
                                <td data-th="Type">{{$post->title}}</td>
                                <td class="coin-name" data-th="Currency">{{$post->redirect_url}}</td>

                                <td class="coin-name" data-th="Currency">{{$post->link}}</td>
                                ...
                                <td data-th="Date">
                                    ...
                                    <a href="{{ url('/admin/posts/' . $post->id . '/edit') }}" title="Edit Brand"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
