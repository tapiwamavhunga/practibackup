                        ...
                        <div class="row g-3">
                          ...
                          <div class="col-xxl-12">
                            <div class="d-flex align-items-center">
                              <img class="me-3 rounded-circle me-0 me-sm-3" src="images/profile/2.png" alt="" width="55" height="55">
                      ...
                      <form action="#">
                        <div class="row g-3">
                          <div class="col-xxl-12">
                            ...
                            <div class="fx-relay-email-input-wrapper"><input type="email" class="form-control" placeholder="Email" style="padding-right: 52px;"><div class="fx-relay-icon" style="top: 0px; bottom: 0px;"><button class="fx-relay-button" id="fx-relay-button" type="button" title="Generate new mask" style="background-image: url(&quot;moz-extension://8f0c5c5e-5f2a-486a-a0e2-0177375c55fd/images/logo-image-fx-relay.svg&quot;);"></button></div></div>
                          </div>
                          <div class="col-xxl-12">
                            <label class="form-label">New Password</label>
                            <input type="password" class="form-control" placeholder="**********">
                            <small class="mt-2 mb-0 d-block">Enable two factor authencation on the security
                              page
                            </small>
                          </div>
                          <div class="col-12">
                      ...
                      <form name="myform" class="personal_validate" novalidate="novalidate">
                        <div class="row g-4">
                          ...
                          <div class="col-xxl-6 col-xl-6 col-lg-6">
                            ...
                            <div class="fx-relay-email-input-wrapper"><input type="email" class="form-control" placeholder="Hello@example.com" name="email" style="padding-right: 52px;"><div class="fx-relay-icon" style="top: 0px; bottom: 0px;"><button class="fx-relay-button" id="fx-relay-button" type="button" title="Generate new mask" style="background-image: url(&quot;moz-extension://8f0c5c5e-5f2a-486a-a0e2-0177375c55fd/images/logo-image-fx-relay.svg&quot;);"></button></div></div>
                          </div>
                          <div class="col-xxl-6 col-xl-6 col-lg-6">
                            <label class="form-label">Date of birth</label>
                            <input type="text" class="form-control hasDatepicker" placeholder="10-10-2020" id="datepicker" autocomplete="off" name="dob">
                          </div>
                          <div class="col-xxl-6 col-xl-6 col-lg-6">
