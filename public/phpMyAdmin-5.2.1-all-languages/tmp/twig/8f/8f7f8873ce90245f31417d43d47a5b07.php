...
class __TwigTemplate_cd85a7dd7cfdde5fc184c5a4f7832fda extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "config/form_display/display.twig", "/srv/users/practitionernew/apps/practitionernew/public/phpMyAdmin-5.2.1-all-languages/templates/config/form_display/display.twig");
    }
}
