...
class __TwigTemplate_7351f89bb6f795e73374828e5d6b133a extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Table comments:");
        ...
        if (( !($context["tbl_is_view"] ?? null) &&  !($context["db_is_system_schema"] ?? null))) {
            // line 13
            echo "            <table class=\"table table-striped table-hover table-sm w-auto caption-top\">
                <caption>";
...
";
    ...
    {
        return new Source("", "table/structure/display_table_stats.twig", "/srv/users/practitionernew/apps/practitionernew/public/phpMyAdmin-5.2.1-all-languages/templates/table/structure/display_table_stats.twig");
    }
}
