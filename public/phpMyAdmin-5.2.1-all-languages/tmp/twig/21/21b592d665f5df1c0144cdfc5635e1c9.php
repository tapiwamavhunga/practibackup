...
class __TwigTemplate_965cf1f7304057ef263b642de76f8f6e extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Go");
    ...
    {
        return new Source("", "table/insert/get_head_and_foot_of_insert_row_table.twig", "/srv/users/practitionernew/apps/practitionernew/public/phpMyAdmin-5.2.1-all-languages/templates/table/insert/get_head_and_foot_of_insert_row_table.twig");
    }
}
