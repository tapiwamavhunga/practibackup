...
class __TwigTemplate_cc005183308f235bfd873467f0c5d15a extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Export the data of all tables.");
  ...
  ";
    ...
    {
        return new Source("", "database/export/index.twig", "/srv/users/practitionernew/apps/practitionernew/public/phpMyAdmin-5.2.1-all-languages/templates/database/export/index.twig");
    }
}
