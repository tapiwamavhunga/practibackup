...
/* login/header.twig */
class __TwigTemplate_c29eaca16f9fe3bcfb08dc9a5689ae87 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "login/header.twig", "/srv/users/practitionernew/apps/practitionernew/public/phpMyAdmin-5.2.1-all-languages/templates/login/header.twig");
    }
}
