...
class __TwigTemplate_bbf7bad6b15e1516c56af11f92265c1e extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Continue");
    ...
    {
        return new Source("", "database/structure/bulk_action_modal.twig", "/srv/users/practitionernew/apps/practitionernew/public/phpMyAdmin-5.2.1-all-languages/templates/database/structure/bulk_action_modal.twig");
    }
}
